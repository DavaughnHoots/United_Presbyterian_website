...
const contentTypes = {
  ...
  historical_context: {
    ...
    fields: {
      ...
      figure: { required: false, label: 'Historical Figure', type: 'text', placeholder: 'e.g., Horatio Spafford, Martin Luther', metadata: true },
      related_hymn: { required: false, label: 'Related Hymn', type: 'text', placeholder: 'e.g., It Is Well With My Soul', metadata: true },
      biblical_reference: { required: false, label: 'Biblical Reference', type: 'text', placeholder: 'e.g., Luke 8:22-25', metadata: true },
      image_url: { required: false, label: 'Historical Image URL', type: 'url', placeholder: 'https://example.com/historical-image.jpg' },
      questions: { required: false, label: 'Application Questions', type: 'array', placeholder: 'Add reflection questions...', metadata: true },
      theme: { required: false, label: 'Theme', type: 'text' },
      tags: { required: false, label: 'Tags', type: 'text', placeholder: 'Comma-separated tags' }
    },
  ...
  interactive_map: {
    ...
    fields: {
      ...
      region: { required: false, label: 'Region', type: 'select', options: ['Israel/Palestine', 'Egypt', 'Jordan', 'Turkey', 'Greece', 'Italy', 'Other'], metadata: true },
      biblical_period: { required: false, label: 'Biblical Period', type: 'select', options: ['Old Testament', 'New Testament', 'Early Church'], metadata: true },
      biblical_events: { required: false, label: 'Biblical Events', type: 'text', placeholder: 'e.g., Jesus walks on water, Paul\'s missionary journey', metadata: true },
      locations: { required: false, label: 'Map Locations', type: 'array', placeholder: 'Add locations with descriptions...', metadata: true },
      theme: { required: false, label: 'Theme', type: 'text' },
      tags: { required: false, label: 'Tags', type: 'text', placeholder: 'Comma-separated tags' }
    },
